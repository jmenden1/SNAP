...
*/
            ...
            if (LOOK_FOR_CHESSBOARD) {
                ...
                if (chess_board) {
                    ...
                    cv::putText(frame, "Dist from chessboard", cv::Point(10, 30), 50, 1,
                                cv::Scalar(0, 0, 0), 2, 8);
                    cv::putText(frame, std::to_string((int) dist.x), cv::Point(10, 80), 50, 1,
                                cv::Scalar(255, 0, 0), 2, 8);
                    cv::putText(frame, std::to_string((int) dist.y), cv::Point(10, 130), 50, 1,
                                cv::Scalar(0, 255, 0), 2, 8);
                    cv::putText(frame, std::to_string((int) dist.z), cv::Point(10, 180), 50, 1,
                                cv::Scalar(0, 0, 255), 2, 8);

                    if (FOLLOW) {

                        cv::putText(frame, "Dist from wished", cv::Point(10, 230), 50, 1,
                                    cv::Scalar(0, 0, 0), 2, 8);
                        cv::putText(frame, std::to_string((int) distFromWished.x), cv::Point(10, 280), 50,
                                    1, cv::Scalar(255, 0, 0), 2, 8);
                        cv::putText(frame, std::to_string((int) distFromWished.y), cv::Point(10, 330), 50,
                                    1, cv::Scalar(0, 255, 0), 2, 8);
                        cv::putText(frame, std::to_string((int) distFromWished.z), cv::Point(10, 380), 50,
                        ...
                        cv::putText(frame, "Asked Dy", cv::Point(100, 280), 50, 1, cv::Scalar(0, 0, 0), 2,
                                    8); //x
                        cv::putText(frame, "Asked Dz", cv::Point(100, 330), 50, 1, cv::Scalar(0, 0, 0), 2,
                                    8); //y
                        cv::putText(frame, "Asked Dx", cv::Point(100, 380), 50, 1, cv::Scalar(0, 0, 0), 2,
                                    8); //z

                        cv::putText(frame, std::to_string(askedDy), cv::Point(300, 280), 50, 1,
                                    cv::Scalar(255, 0, 0), 2, 8);
                        cv::putText(frame, std::to_string(askedDz), cv::Point(300, 330), 50, 1,
                                    cv::Scalar(0, 255, 0), 2, 8);
                        cv::putText(frame, std::to_string(askedDx), cv::Point(300, 380), 50, 1,
                                    cv::Scalar(0, 0, 255), 2, 8);
            ...
            cv::putText(frame, help, cv::Point(10,465), 50, 1, cv::Scalar(255,255,255), 2);
            cv::putText(frame, help, cv::Point(10,465), 50, 1, cv::Scalar(0,0,0), 1);

            cv::putText(frame, std::to_string(d.getBatteryLvl()), cv::Point(800, 30),
                        50, 1, cv::Scalar(255, 0, 255), 3, 8);
